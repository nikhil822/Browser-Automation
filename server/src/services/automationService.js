...
export async function executeAutomation(actions) {
                            ...
                            try {
                                ...
                                if (!clicked) {
                                    ...
                                    const formSubmitted = await page.evaluate(() => {
                                        ...
                                        const forms = Array.from(document.querySelectorAll('form'));
                                        const loginForm = forms.find(form => form.querySelector('input[type="password"]') !== null);
                                        if (loginForm) {
...
async function findInputField(page, descriptor) {
...
async function findElement(page, descriptor) {
